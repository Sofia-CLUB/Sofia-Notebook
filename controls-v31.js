(() => {
  ...
  document.documentElement.dataset.controlsVersion = "31";
  if ($("appVersionBadge")) $("appVersionBadge").textContent = "v31";

  /* ---------- FULL SCREEN v30: controls remain visible ---------- */
  let exitButton = $("v31FullscreenExit");
  if (!exitButton) {
    exitButton = document.createElement("button");
    exitButton.id = "v31FullscreenExit";
  ...
  async function enterBoardFullscreen() {
    document.body.classList.add("board-fullscreen-v31");
    try {
  ...
  async function exitBoardFullscreen() {
    document.body.classList.remove("board-fullscreen-v31");
    try {
  ...
  if (fullscreenBtn) {
    fullscreenBtn.addEventListener("click", e => {
      ...
      if (document.body.classList.contains("board-fullscreen-v31")) exitBoardFullscreen();
  ...
  document.addEventListener("fullscreenchange", () => {
    if (!document.fullscreenElement && document.body.classList.contains("board-fullscreen-v31")) {
      document.body.classList.remove("board-fullscreen-v31");
    }
  });
  ...
  let floatingDelete = $("v31ObjectDelete");
  if (!floatingDelete) {
    floatingDelete = document.createElement("button");
    floatingDelete.id = "v31ObjectDelete";
