(() => {
  ...
  document.documentElement.dataset.controlsVersion = "36";
  if ($("appVersionBadge")) $("appVersionBadge").textContent = "v36";

  /* ---------- FULL SCREEN v30: controls remain visible ---------- */
  let exitButton = $("v36FullscreenExit");
  if (!exitButton) {
    exitButton = document.createElement("button");
    exitButton.id = "v36FullscreenExit";
  ...
  async function enterBoardFullscreen() {
    document.body.classList.add("board-fullscreen-v36");
    try {
  ...
  async function exitBoardFullscreen() {
    document.body.classList.remove("board-fullscreen-v36");
    try {
  ...
  if (fullscreenBtn) {
    fullscreenBtn.addEventListener("click", e => {
      ...
      if (document.body.classList.contains("board-fullscreen-v36")) exitBoardFullscreen();
  ...
  document.addEventListener("fullscreenchange", () => {
    if (!document.fullscreenElement && document.body.classList.contains("board-fullscreen-v36")) {
      document.body.classList.remove("board-fullscreen-v36");
    }
  });
  ...
  let floatingDelete = $("v36ObjectDelete");
  if (!floatingDelete) {
    floatingDelete = document.createElement("button");
    floatingDelete.id = "v36ObjectDelete";
